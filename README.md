...
<blockquote>
<p dir="rtl">
این تونل کاملاً دستی نصبه و هیچ اسکریپت آماده‌ای نداره.<br>
...
<li><code>mtu</code> → حداکثر اندازه بسته که از تونل رد می‌شه. مطمئن شید ≤ MTU اینترفیس فیزیکی باشه.</li>
